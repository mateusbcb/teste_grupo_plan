...
@section('content')
    <div class="container my-5 text-white">
        ...
        <div class="card text-bg-dark border-0 shadow">
            <div class="card-body">
                <h3 class="card-title mb-5 mt-2">Eletrodomesticos</h3>

                <div class="w-75 mx-auto float-start">
                ...
                <div class="text-end">
                    <a href="#" class="btn btn-warning shadow-lg">
                            ...
                            <tbody>
                                @forelse ($eletrodomesticos as $eletrodomestico)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('eletrodomesticos', ['id' => $eletrodomestico->id]) }}" class="btn btn-dark text-info">
                                            ...
                                            <a href="" class="btn btn-dark text-success">
